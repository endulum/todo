...
let art = Todo('Art Projects', 'medium', undefined, 'Creative projects to complete for portfolio.');
...
let books = Todo('Books to Read', 'medium', undefined, 'Book recommendations I have been given by friends and other folks.');
...
let fams2 = Todo('Articulated Fidget Toy', 'none', undefined, 'Sure, \'collector\'s item\' you might say. Might we suggest an axe that doesn\'t have teeth and eyeballs?');
...
let fams3 = Todo('Salt and Pepper', 'high', undefined, 'Always remember to floss.');
...
let fams4 = Todo('Filter Fiend', 'low', undefined, 'This parrot has learned the ways of its crew, and pilfers all that shines.');
fams4.add(Task('This cannibalistic snail produces a powerful venom.'));
fams4.add(Task('An ending of narrative merit.'));

let fams5 = Todo('Eel of the Depths', 'low', undefined, 'Many flocks of Raptorik have found life on the high seas is full of adventure... and shiny things!');
...
let fams6 = Todo('Spring Glade Lord', 'medium', undefined, 'Some dryads gain additional abilities with the changing of the seasons. Spring Lords hold dominion over most plant life in their homes during the season of new blooms.');
