...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _logic_core_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./logic/core.js */ "./src/logic/core.js");
...
const Todo = (title, priority = 'no priority', due = 0, description = '') => {
    ...
    return {
        ...
        print: () => {
            ...
            if (due != 0) {
                list += `due on ${(0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(due, 'MM/dd/yyyy')} (${(0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])((due), {addSuffix: true})})\n\n`;
            } else {
                list += `no due date\n\n`;
            }
            for (let task of tasks) {
